...
buildCommand.Options.Add(new CliOption("-c", description: "The configuration to use for building the project. The default for most projects is 'Debug'."));
buildCommand.Options.Add(new CliOption("-f", description: "The target framework to build for. The target framework must also be specified in the project file."));
buildCommand.Options.Add(new CliOption("-r", description: "The target runtime to build for."));
...
buildCommand.Options.Add(new CliOption("-v", description: "Set the MSBuild verbosity level. Allowed values are q[uiet], m[inimal], n[ormal], d[etailed], and diag[nostic]."));
buildCommand.Options.Add(new CliOption("-o", description: "The output directory to place built artifacts in."));
...
buildCommand.Options.Add(new CliOption("--helpR", ["-h", "--help"], "Show command line help."));
...
//   dotnet build --help-r html     (Buyah)
